...
---
- Get detailed student with batches **(Only for teachers with appropriate permission)**

**POST** /user/student - Returns a list of the student detailed.
...
- Remove a teacher **(Only for teachers with appropriate permission)**

**POST** /user/remove_teacher- Creates/Invites new teacher to the organization.
...
**POST** /attendance/reset - Resets the attendance for everyone for that day.
...
"attendance_id":"7a7s7a78as9dasdada"  //_id of a attendance for that day
}
...
---
- Get detailed info of one batch

**POST**: /batches/details - Returns all the batches on a specified date.
...
"batch_id":"a6f7as6f7d8f"  //_id of the batch
...
- Get one student payment details **(Only for teachers with appropriate permission)**

**POST** /fees/student - Returns a list of all installlments which have been paid or not for a student of a batch.
...
"student_id":"8df7s8d9f7s89df7s89f7s8",
"batch_id":"34634tw46wgw4g6w45g656bh"
